-- AUTHOR: github.com/glepnir
-- REPO: github.com/nvimdev/modeline.nvim
-- LICENSE: https://github.com/nvimdev/modeline.nvim/blob/main/LICENSE
-- MODIFIED AND MAINTAINED BY: github.com/maxmx03
