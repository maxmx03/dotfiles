...
function M.load_faces(base46, config)
  ...
  hl(0, 'MoreMsg', { fg = base46.base_30.base09 })
  ...
  if config.transparency then
    ...
    hl(0, 'BufferLineBufferSelected', { fg = base46.base_30.base05, bg = base46.base_30.base00 })
    hl(0, 'BufferLineSeparator', { fg = background })
    hl(0, 'BufferLineSeparatorSelected', { fg = background, bg = base46.base_30.base00 })
  ...
  hl(0, 'TabLine', { fg = base46.base_16.base03, bg = base46.base_30.base00 })
  hl(0, 'TabLineFill', { fg = base46.base_16.base05, bg = base46.base_30.base00 })
  ...
  hl(0, 'WarningMsg', { fg = base46.base_30.base0A })
