...
local doomone = {
  ...
  base_30 = {
    ...
    base0G = '#51afef', -- Markup Heading 1
    base0H = '#46d9ff', -- Markup Heading 2
    base0I = '#ECBE7B', -- Markup Heading 3
    base0J = '#a9a1e1', -- Markup Heading 4
    base0K = '#c678dd', -- Markup Heading 5
    base0L = '#ff6c6b', -- Markup Heading 6
