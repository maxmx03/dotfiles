...
local color = require 'horizon.color'
...
---@param config? horizon.hi.config
...
M.load = function(config)
  ...
  hi('FloatTitle', { bg = c.red, reverse = true }, { mix = 'fg' })
  ...
  hi('PmenuSel', { fg = c.yellow_orange, reverse = true })
  hi('PmenuKind', { link = 'Pmenu' })
  hi('PmenuKindSel', { link = 'PmenuSel' })
  hi('PmenuExtra', { link = 'Pmenu' })
  hi('PmenuExtraSel', { link = 'PmenuSel' })
  hi('PmenuSbar', { bg = c.base03 })
  hi('PmenuThumb', { bg = c.yellow_orange })
  hi('Question', { fg = c.diag_info })
  hi('QuickFixLine', { fg = c.base0, bg = c.base03 })
  hi('Search', { fg = c.yellow_orange, bold = true }, { mix = 'bg' })
  ...
  hi('Tag', { fg = c.red })
  hi('TagAttribute', { fg = c.orange })
  hi('TagDelimiter', { fg = c.red })
  hi('Delimiter', { fg = c.base0 })
  hi('SpecialComment', { link = 'Statement' })
  hi('Debug', { fg = c.purple })
  hi('Underlined', { fg = c.yellow, underline = true })
  hi('Ignore', {})
  hi('Error', { fg = c.diag_error, bold = true })
  hi('Todo', { fg = c.yellow_orange })
  ...
  hi('@property.json', { fg = c.red })
  hi('@property.yaml', { fg = c.red })
  ...
  hi('@markup.italic', { fg = c.cyan, italic = true })
  ...
  hi('@markup.heading.2', { fg = c.yellow_orange })
  ...
  hi('@markup.list.checked', { fg = c.yellow_orange })
  ...
  hi('LspReferenceRead', { fg = c.yellow_orange }, { mix = 'bg' })
  hi('LspReferenceWrite', { fg = c.yellow_orange }, { mix = 'bg' })
  ...
  hi('TelescopeSelection', { fg = c.yellow_orange, bg = c.base02 })
  hi('TelescopeSelectionCaret', { fg = c.red, bg = c.base02 })
  hi('TelescopeMultiIcon', { fg = c.red })
  hi(
    'TelescopeNormal',
    { fg = c.base0, bg = c.base04 },
  ...
  hi('RenderMarkdownH1Bg', { fg = c.yellow_orange }, { mix = 'bg' })
  hi('RenderMarkdownH2Bg', { fg = c.yellow_orange }, { mix = 'bg' })
