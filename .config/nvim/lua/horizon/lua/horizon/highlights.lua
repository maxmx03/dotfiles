...
M.load = function(config)
  ...
  hi('FloatTitle', { bg = c.yellow_orange, reverse = true }, { mix = 'fg' })
  ...
  hi('@markup.heading', { fg = c.yellow_orange, bold = true })
  hi('@markup.heading.1', { fg = c.yellow_orange })
  ...
  hi('TelescopeSelectionCaret', { fg = c.yellow_orange, bg = c.base02 })
  hi('TelescopeMultiIcon', { fg = c.yellow_orange })
  hi(
    'TelescopeNormal',
    { fg = c.base0, bg = c.base04 },
