...
M.base_30 = {
  ...
  base0C = '#ff9e64', -- Markup Bold
  base0D = '#ff9e64', -- Markup Italic
  base0E = '#ff9e64', -- Markup url
  base0F = '#ff9e64', -- Markup Inline Code
  base0G = '#7aa2f7', -- Markup Heading 1
  base0H = '#7aa2f7', -- Markup Heading 2
  base0I = '#2ac3de', -- Markup Heading 3
  base0J = '#2ac3de', -- Markup Heading 4
  base0K = '#73daca', -- Markup Heading 5
  base0L = '#73daca', -- Markup Heading 6
  base0M = '#b4f9f8', -- Markup Tag
  base0N = '#73daca', -- Markup Tag Attribute
  base0O = '#7dcfff', -- Markup Tag Delimiter
...
M.base_16 = {
  ...
  base06 = '#73daca', -- Property, Variable Member
  base07 = '#7dcfff', -- PreProc, Include, Define, Macro, PreCondit
  ...
  base0A = '#2ac3de', -- Classes, Markup Bold, Search Text Background
