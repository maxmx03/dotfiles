--- Credit and Reference: morhetz/gruvbox
...
M.base_30 = {
  ...
  base0C = '#fe8019', -- Markup Bold
  base0D = '#d3869b', -- Markup Italic
  base0E = '#bdae93', -- Markup url
  base0F = '#8ec07c', -- Markup Inline Code
  base0G = '#b8bb26', -- Markup Heading 1
  base0H = '#b8bb26', -- Markup Heading 2
  base0I = '#fabd2f', -- Markup Heading 3
  base0J = '#fabd2f', -- Markup Heading 4
  base0K = '#fe8019', -- Markup Heading 5
  base0L = '#fe8019', -- Markup Heading 6
  base0M = '#8ec07c', -- Markup Tag
  base0N = '#83a598', -- Markup Tag Attribute
  base0O = '#8ec07c', -- Markup Tag Delimiter
...
M.base_16 = {
  ...
  base06 = '#83a598', -- Property, Variable Member
  base07 = '#fb4934', -- PreProc, Include, Define, Macro, PreCondit
  base08 = '#83a598', -- Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
  base09 = '#d3869b', -- Integers, Boolean, Constants, XML Attributes, Markup Link Url
  base0A = '#fabd2f', -- Classes, Markup Bold, Search Text Background
  base0B = '#8ec07c', -- Strings, Inherited Class, Markup Code, Diff Inserted
  base0C = '#fe8019', -- Support, Regular Expressions, Escape Characters, Markup Quotes
  base0D = '#b8bb26', -- Functions, Methods, Attribute IDs, Headings
  base0E = '#fb4934', -- Keywords, Storage, Selector, Markup Italic, Diff Changed
  base0F = '#fb4934', -- Opening/Closing Embedded Language Tags, e.g. `<?php ?>`
}

M.groups = {
  LspInlayHint = { fg = M.base_16.base03 },
}
