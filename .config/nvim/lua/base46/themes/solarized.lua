--- Credit And Reference: maxmx03/solarized.nvim
...
M.base_16 = {
  ...
  base06 = '#268bd3', -- Property, Variable Member
  base07 = '#849900', -- PreProc, Include, Define, Macro, PreCondit
  base08 = '#268bd3', -- Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
  base09 = '#6c71c4', -- Integers, Boolean, Constants, XML Attributes, Markup Link Url
  base0A = '#dc322f', -- Classes, Markup Bold, Search Text Background
  ...
  base0D = '#b58900', -- Functions, Methods, Attribute IDs, Headings
...
M.groups = {
  ['@punctuation.bracket.php'] = { fg = M.accent.magenta },
}
